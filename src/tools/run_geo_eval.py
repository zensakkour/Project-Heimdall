...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    report = {
        ...
        "index_projection_paths": list(cfg.geolocator.retrieval_index_projection_paths) if cfg else None,
        "retrieval_projection_path": cfg.geolocator.retrieval_projection_path if cfg else None,
        ...
        "retrieval_structure_rerank_top_n": cfg.geolocator.retrieval_structure_rerank_top_n if cfg else None,
        "retrieval_structure_rerank_weight": cfg.geolocator.retrieval_structure_rerank_weight if cfg else None,
